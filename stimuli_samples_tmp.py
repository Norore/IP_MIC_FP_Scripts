...
"""
datacols = data[["DonorIDscanned", "ExtractionName", "Donor_ID.", "Visit", "StimulationNumber",	"StimulationName", "StimulationTime", "Matrix_RackBarcodeScanned", "Matrix_TubeBarcodeScanned", "Matrix_TubePosition."]]

datacols.rename(columns={"Donor_ID.": "DonorID", "Matrix_RackBarcodeScanned": "Box", "Matrix_TubeBarcodeScanned": "Name", "Matrix_TubePosition.": "Position"}, inplace=True)
